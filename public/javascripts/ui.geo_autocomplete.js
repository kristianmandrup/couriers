        ...
        // console.log('address', _address);
          ...
          // console.log('status', _status);
            ...
            // console.log('types', _types);                        
              ...
              // console.log('geometry', _result.geometry);              
							if (len && _result.geometry && _result.geometry.viewport) {
                if (self.options.geocoder_address) {
                  // console.log('geocoder_address - formatted_address');
                 _place = _result.formatted_address;
                } else {
                  // console.log('not geocoder_address');
